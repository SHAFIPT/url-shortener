...
const LandingPage = () => {
  ...
  const [isProcessingPendingUrl, setIsProcessingPendingUrl] = useState(false);
  ...
  const {
    fromPendingUrl,
    shortenedUrl: pendingShort,
    originalUrl: pendingLong,
  } = location.state || {};

  const { mutate: shortenUrl, isPending } = useShortenUrl();

  useEffect(() => {
    if (fromPendingUrl && pendingShort && pendingLong) {
      setIsProcessingPendingUrl(true);

      setTimeout(() => {
        setShowResult(true);
        setShortenedUrl(pendingShort);
        setUrl(pendingLong);
        setIsProcessingPendingUrl(false);
  ...
  }, [fromPendingUrl, pendingShort, pendingLong]);
        ...
        <section className="relative z-10 px-6 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up">
              Professional <span className="text-shimmer">URL Shortener</span>{" "}
              for Modern Teams
            </h1>
                  ...
                  <div className="flex space-x-4">
                    <div className="flex-1">
                      <Input
                        ...
                        onKeyDown={(e) =>
                          e.key === "Enter" && handleShortenClick()
                        }
                      />
                    </div>
                    <Button
                      ...
                      className={isPending ? "pulse-glow" : ""}
                    >
              ...
              <Card className="glass max-w-3xl mx-auto mb-12 animate-scale-in shadow-premium glow-primary">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardDescription className="text-base">
                    Your URL has been successfully shortened and is ready to
                    share
                  </CardDescription>
                </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="glass card-hover">
                <CardHeader>
                  ...
                  <CardDescription>
                    Real-time analytics with geo-distribution, click tracking,
              ...
              <Card className="glass card-hover">
                <CardHeader>
                  ...
                  <CardDescription>
                    Lightning-fast redirects with global edge locations.
            ...
            <Card className="glass p-12 shadow-premium">
              <CardHeader>
                ...
                <CardDescription className="text-lg mb-8">
                  Join thousands of developers and teams using LinkSpark Pro for
                  their URL shortening needs.
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <footer className="relative z-10 border-t border-border/20 glass">
          <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            <div className="mt-8 pt-8 border-t border-border/20 text-center text-sm text-muted-foreground">
              © 2024 LinkSpark Pro. Built with precision for modern
              applications.
            </div>
          </div>
        </footer>
